...
import { useDeleteBidMutation, useGetSellerBidsQuery } from '../../redux/slices/bidApiSlice';
...
const RecivedBids = () => {
  ...
  const {data : sellerBids,refetch ,isLoading , error} = useGetSellerBidsQuery();
